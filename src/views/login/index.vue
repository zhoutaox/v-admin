  ...
  <div class="login-container">
    ...
    <div class="right">
      <div class="main">
        ...
        <div class="desc">
          没有账户？<span>免费注册 <v-icon icon="right-btn"></v-icon></span>
        </div>
        <div class="tabs">
          <div class="tab-item active">账号密码登录</div>
          <div class="tab-item">手机验证码登录</div>
        </div>
        <n-form ref="formRef" :model="formValue" :rules="rules" :show-label="false" size="large">
          ...
          <n-form-item>
            <div class="remember"><n-checkbox>记住密码</n-checkbox><span>忘记密码?</span></div>
          </n-form-item>
          <n-form-item>
